...
@section('content')
    ...
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px] z-10">
        <div class="flex flex-col gap-1">
            <p>Search Results</p>
            <h1 class="font-bold text-xl leading-[30px]">Found {{ $boardingHouses->count() }} Kos</h1>
        </div>
    ...
    <section id="SearchResults" class="relative flex flex-col gap-4 px-5 mt-[30px] pb-[138px] z-10">
        ...
        @else
            <div class="flex flex-col items-center justify-center gap-4 py-10">
                <img src="{{ asset('assets/images/icons/note-favorite-grey.svg') }}" class="w-20 h-20" alt="icon">
                <div class="text-center">
                    <h3 class="font-semibold text-lg">No Results Found</h3>
                    <p class="text-sm text-ngekos-grey">Try searching with different keywords</p>
                </div>
                <a href="{{ route('find-kos') }}" class="rounded-full px-6 py-3 bg-ngekos-orange text-white font-semibold">Search Again</a>
            </div>
        @endif
    </section>
