        ...
        <form action="{{ route('booking.information.save', $boardingHouse->slug) }}" 
            ...
            <div id="InputContainer" class="flex flex-col gap-[18px]">
                ...
                <div class="flex flex-col w-full gap-2 px-5">
                    ...
                    <label
                        class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white focus-within:ring-1 focus-within:ring-[#91BF77] transition-all duration-300 @error('phone') ring-1 ring-red-500 @enderror">
