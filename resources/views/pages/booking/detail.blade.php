            ...
            <div class="flex flex-col gap-4 pt-[22px]">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-semibold">
                      {{ \Carbon\Carbon::parse($transaction->start_date)->isoFormat('DD MMMM YYYY') }}
                    </p>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                    ...
                    <p class="font-semibold">
                      {{ \Carbon\Carbon::parse($transaction->start_date)->addMonths($transaction->duration)->isoFormat('DD MMMM YYYY') }}
                    </p>
                </div>
            </div>
        </div>
        <div class="accordion group flex flex-col rounded-[30px] p-5 bg-[#F5F6F8] mx-5 mt-5 overflow-hidden has-[:checked]:!h-[68px] transition-all duration-300">
            ...
            <div class="flex flex-col gap-4 pt-[22px]">
                ...
                @if ($transaction->payment_method === 'full_payment')
                    <p class="font-semibold text-ngekos-orange">Full Payment 100%</p>
                @else
                    <p class="font-semibold text-ngekos-orange">Down Payment 30%</p>
                @endif
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
