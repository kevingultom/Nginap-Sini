  ...
  <div id="Background" class="absolute top-0 w-full h-[430px] rounded-b-[75px] bg-[linear-gradient(180deg,#F2F9E6_0%,#D2EDE4_100%)]"></div>
        <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
                        ...
                        <div class="flex flex-col gap-3 w-full">
                            ...
                            <div class="flex items-center gap-[6px]">
                                ...
                                <p class="text-sm text-ngekos-grey">
                                  ...
                                  {{ \Carbon\Carbon::parse($transaction->start_date)->addMonth($transaction->duration)->isoFormat('D MMM YYYY') }}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex flex-col gap-[14px]">
                <a href="{{ route('home') }}" 
                class="w-full rounded-full p-[14px_20px] text-center font-bold text-white bg-ngekos-orange">Explore Other Kos</a>
                <form action="{{ route('check-booking.show')}}" method='POST'> 
                    ...
                    <button type="submit" 
                    class="w-full rounded-full p-[14px_20px] text-center font-bold text-ngekos-orange border border-ngekos-orange bg-white">
