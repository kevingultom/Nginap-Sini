        ...
        <form action="{{ route('check-booking.show') }}" method="POST"
            ...
            <div id="InputContainer" class="flex flex-col gap-[18px]">
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white ring-1 transition-all duration-300 {{ $errors->has('code') ? 'ring-[#EF4444]' : 'ring-[#F1F2F6] focus-within:ring-[#91BF77]' }}">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white ring-1 transition-all duration-300 {{ $errors->has('email') ? 'ring-[#EF4444]' : 'ring-[#F1F2F6] focus-within:ring-[#91BF77]' }}">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white ring-1 transition-all duration-300 {{ $errors->has('phone_number') ? 'ring-[#EF4444]' : 'ring-[#F1F2F6] focus-within:ring-[#91BF77]' }}">
                ...
                @if (session('error'))
                    <p class="text-center" style="color: #EF4444;">{{ session('error') }}</p>
                @endif
