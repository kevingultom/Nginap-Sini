...
class BookingController extends Controller
{
    ...
    public function information($slug)
    {
        ...
        return view('pages.booking.information', compact('boardingHouse', 'room', 'transaction')); 
    }
    ...
    public function checkout($slug)
    {
        ...
        $boardingHouse = $this->boardingHouseRepository->getBoardingHouseBySlug($slug);
        $room = $this->boardingHouseRepository->getBoardingHouseRoomById($transaction['room_id']);
        return view('pages.booking.checkout', compact('boardingHouse', 'room', 'transaction')); 
    }
    ...
    {
        $transaction = $this->transactionRepository->getTransactionByCode($request->input('order_id'));
        if (!$transaction) {
    ...
    public function show(BookingShowRequest $request)
    {
        ...
        if (!$transaction) {
            return redirect()->back()->with('error', 'Data Transaksi Tidak Ditemukan')->withInput();
        }
